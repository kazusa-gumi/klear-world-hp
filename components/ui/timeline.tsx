    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-2xl">
          From initial consultation to key handover, we provide comprehensive support throughout your property purchase journey in Japan. Here's what you can expect when working with us.
        </p>
      </div>
